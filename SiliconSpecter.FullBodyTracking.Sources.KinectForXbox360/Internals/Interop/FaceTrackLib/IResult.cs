...
namespace SiliconSpecter.FullBodyTracking.Sources.KinectForXbox360.Internals.Interop.FaceTrackLib
{
  ...
  public interface IResult
  {
    ...
    [Obsolete]
    [PreserveSig]
    int CopyTo(IResult destination);
    ...
    [Obsolete]
    void GetFaceRect(out IntPtr rectangle);
    ...
    [Obsolete]
    void Get2DShapePoints(out IntPtr points, out uint pointCount);
    ...
    void Get3DPose(out float scale, out FaceTrackingVector3 rotation, out FaceTrackingVector3 translation);
    ...
    void GetAUCoefficients(out IntPtr animationUnitCoefficients, out uint animationUnitCoefficientCount);
  }
}
